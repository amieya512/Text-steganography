...
def extractFunc(CM_HM, ZWC_reverse):
    """
    Extracts a hidden message from stego text using randomized character mapping.

    Args:
        CM_HM: Stego message (cover message with hidden message)
        ZWC_reverse: Reverse mapping dictionary (invisible chars -> binary pairs)

    Returns:
        Extracted encrypted secret message
    """
