...
# Fixed zero-width character mapping
ZWC = {
    "00": u"\u200C",
    "01": u"\u202C",
    "10": u"\u202D",
...
def embedFunc(SM, CM):
    ...
    # NOTE: this follows the original implementation and reuses SM_binary
    # across calls; we keep this behavior to match the base project.
    for letter in SM:
        n = ord(letter)
        factors = []
